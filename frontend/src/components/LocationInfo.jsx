...
// Ported from shelter-route-planner/frontend/src/components/LocationInfo.jsx.
// Field names adapted to our shelter shape: shelter.lat/lon instead of
// shelter.latitude/longitude, destination.lat/lon instead of
// destination.latitude/longitude (our addressRoute "to" point uses lat/lon —
// see App.jsx / Map.jsx). Logic and layout otherwise unchanged.
...
const LocationInfo = ({
  ...
  useEffect(() => {
    ...
    const distance = calculateDistance(currentPosition.lat, currentPosition.lng, destination.lat, destination.lon);
